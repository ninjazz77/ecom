      ...
      <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
            <div>
              ...
              <h1 className="mt-3 text-4xl font-semibold leading-tight md:text-5xl">
                Browse the catalog with faster filters, bigger visuals, and
                refined pacing.
              </h1>
              <p className="mt-4 max-w-2xl text-sm leading-7 text-slate-400">
                A premium browsing experience with clear status, effortless
                sorting, and product surfaces built for conversion.
              </p>
            </div>
            <div className="grid grid-cols-3 gap-3">
              {[
                ...
                <div
                  key={label}
                  className="rounded-[1.75rem] border border-white/10 bg-white/5 px-4 py-5 text-center"
                >
        ...
        <div className="grid gap-7 lg:grid-cols-[340px_1fr]">
          ...
          <div className="flex flex-col">
            <div className="mb-5 rounded-[1.75rem] border border-white/10 bg-white/5 p-4 shadow-[0_16px_50px_rgba(0,0,0,0.2)] backdrop-blur md:flex md:items-center md:justify-between">
              ...
              <div className="mt-4 flex flex-col gap-3 sm:mt-0 sm:flex-row sm:items-center">
                <Select onValueChange={setSortOrder}>
                  <SelectTrigger className="w-[220px] bg-slate-950 text-white border border-slate-700">
            ...
            <div className="grid grid-cols-1 gap-7 sm:grid-cols-2 xl:grid-cols-3">
              {loading ? (
                ...
                <div className="col-span-full surface-card p-10 text-center text-slate-400">
